...
Se encontrou um bug no Portal do Material Escolar você pode reportá-lo usando a ferramenta de [issues do GitHub](https://github.com/prefeiturasp/PortalMaterialEscolar/issues). Porém antes de enviar seu bug é importante fazer as seguintes verificações:
...
Se o bug realmente não foi resolvido ou acolhido então está na hora de [criar uma nova issue](https://github.com/prefeiturasp/PortalMaterialEscolar/issues/new).  Siga o template fornecido.
...
1. Certifique-se de que sua ideia já não esteja sendo abordada dentro do conjuntos de issues [issues do GitHub](https://github.com/prefeiturasp/PortalMaterialEscolar/issues);
...
Para criar seu pedido de recurso basta [criar uma nova issue](https://github.com/prefeiturasp/PortalMaterialEscolar/issues/new) usando o label **recurso**. /new) usando o label **recurso**.
...
- Fale sobre o Portal do Material Escolar nas suas redes sociais, blogs, etc. Espalhe a palavra;
